...
polyfills_1.applyPolyfills();
const onLoad = function () {
    globals_1.loadPageInfo();
    mqfy_1.findQuillGroups(); // Groups of quills
    findPyGenerators_1.findPyGenerators(); // An interface for dynamic generated questions
};
// Inject required dependencies on the page
// On jquery ready
$(function () {
    utils_1.createLinkSheet(globals_1.cfg.BASE_URL + "/lib/mathquill.matrix.css");
    //check if iedibAPI is in page
    if (window.iedibAPI) {
        utils_1.insertScript(globals_1.cfg.BASE_URL + "/lib/mathquill.matrix.min.js", onLoad);
    }
    else {
        utils_1.insertScript('https://piworld.es/iedib/assets/iedib-api.js', function () {
            utils_1.insertScript(globals_1.cfg.BASE_URL + "/lib/mathquill.matrix.min.js", onLoad);
        });
    }
});
