export const BASE_URL:string =  "https://piworld.es/iedib/matheditor";
...
export function forEach(obj: any, cb: Function) {
...
export function _createStyleSheet(src: string, id?: string) {
...
var _createLinkSheet = function (href: string, id?: string) {
